        ...
        <div class="col">
            <div class="card mt-3">
                <div class="card-header bg-secondary text-white">
                    Editar Produto
                    <a href="index.php?classe=ProdutoController&metodo=abrir_consulta" class="btn btn-primary btn-sm float-right"><i class="fas fa-search"></i> Voltar para a consulta</a>
                </div>
                <div class="card-body">
                    <form action="index.php?classe=ProdutoController&metodo=atualizar" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nomeproduto" placeholder="Informe o nome do produto" value="<?php echo $dados->nomeproduto;?>" required>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="preco">Preço</label>
                                    <input type="number" step="any" class="form-control" name="preco" placeholder="Informe o preço do produto" value="<?php echo $dados->preco;?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                    <div class="form-group">
...
<script>
    ...
    $("#codcategoria").val("<?php echo $dados->codcategoria;?>");
    $("#destaque").val("<?php echo $dados->destaque;?>");
</script>
</body>
</html>